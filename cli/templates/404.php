...
<!--                                    </td>-->
                ...
                <div class="col-md-6 col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Checked paths</h4>
                        </div>
                        <div class="table-responsive">
                            <table class="table card-table table-vcenter">
                                <?php foreach ($valetConfig['paths'] as $path): ?>
                ...
                <div class="row text-center align-items-center flex-row-reverse">
                    <div class="col-lg-auto ml-lg-auto">
                        <ul class="list-inline list-inline-dots mb-0">
                            ...
                            <!--                  <li class="list-inline-item"><a href="" target="_blank" class="link-secondary">Source code</a></li>-->
                        </ul>
                    </div>
                    <div class="col-12 col-lg-auto mt-3 mt-lg-0">
                        Copyright © 2020
                        <a href="." class="link-secondary">Valet+ reforged</a>.
                        All rights reserved.
                    </div>
                </div>
            </div>
...
<style>
    <?php include 'assets/css/tabler.css'; ?>
</style>
<!-- Libs JS -->
<script>
    <?php include 'assets/js/tabler.min.js'; ?>
